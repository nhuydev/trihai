...
const mockData = [
  {
    id: 1,
    image:
      "https://f6-zpcloud.zdn.vn/4784766124107523582/e9b61979cafc0ea257ed.jpg",
...
function App() {
  ...
  console.log("🚀 ~ file: App.tsx ~ line 258 ~ App ~ canvasData", canvasData);
  ...
  console.log("🚀 ~ file: App.tsx ~ line 264 ~ App ~ elRefs", elRefs);
  ...
  return (
    <div className="flex flex-col items-center">
      <div ref={refComponent} className="w-fit hidden">
            ...
            <div className="flex justify-center">
              <Container style={{ margin: 0 }} lg>
                ...
                <Grid.Container gap={1}>
                  {dataImage &&
                    dataImage.length > 0 &&
                    dataImage.slice(i * 18, (i + 1) * 18).map((item, index) => (
                      <Grid key={index} xs={4} md={2} xl={2}>
                        <div className="flex flex-col">
                          <Image
                            objectFit="cover"
